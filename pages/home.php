<?php
/**
 * Home Page for TigerLaundry (2011 Recode Version)
 * 
 * This page provides a quick overview of what the project is, what we aim to
 * do, and show the quick statuses of the locations.
 * 
 * TODO: Show quick statuses of the locations.
 * 
